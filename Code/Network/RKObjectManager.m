                                ...
                                parameters:(NSDictionary *)parameters
{
    ...
    if (parameters && !([method isEqualToString:@"GET"] || [method isEqualToString:@"HEAD"] || [method isEqualToString:@"DELETE"])) {
        ...
        BOOL shouldIgnoreParametersInSignature = ([self.HTTPClient isMemberOfClass:[AFHTTPClient class]] || [self.HTTPClient isMemberOfClass:[AFXAuthClient class]]) && (![self.requestSerializationMIMEType isEqualToString:RKMIMETypeFormURLEncoded]);
