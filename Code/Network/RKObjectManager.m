                                ...
                                parameters:(NSDictionary *)parameters
{
    ...
    if (parameters && !([method isEqualToString:@"GET"] || [method isEqualToString:@"HEAD"] || [method isEqualToString:@"DELETE"])) {
        ...
        BOOL shouldIgnoreParametersInSignature = ([self.HTTPClient isKindOfClass:[AFHTTPClient class]]) && (![self.requestSerializationMIMEType isEqualToString:RKMIMETypeFormURLEncoded]);
